...
<img src="https://svg.wavedrom.com/{signal:[{name:'Tx',wave:'x==|=|====.|xxxxxxx',data:['w','id','n','nc','cmd','val']},{node:'..A.B..E..C.D'}],head:{text:'Write command'},edge:['A+B 8bytes','C+D n bytes','E+C nc bytes']}"/>
